...
**Dominions 6** の仕様・攻略・国家・魔法・アイテム情報を、日本語で体系的に整理するWikiです。

旧来の日本語Dominions Wikiのように、**左メニューから必要な項目へすぐ移動できる「攻略辞書」型**を目指します。同時に、Dominions 6固有の変更や対人戦での実戦的な意味も分離して記述します。

## 関連リンク

- [Illwinter Game Design - Dominions 6](https://www.illwinter.com/dom6/)
...
- [Dominions 4 日本語Wiki（旧作・参考）](https://wikiwiki.jp/dominions4/)

!!! warning "旧作Wikiの情報について"
    Dominions 4 / 5 の記事は考え方の参考になる場合がありますが、数値、研究レベル、Magic Path、戦闘ルール、国家構成はDominions 6で変更されていることがあります。このWikiではDom6のゲーム内表示・公式資料・現行データを優先します。
...
- [Earth](magic/paths/earth.md)
- [Astral](magic/paths/astral.md)
- [Death](magic/paths/death.md)
- [Nature](magic/paths/nature.md)
- [Glamour](magic/paths/glamour.md)
